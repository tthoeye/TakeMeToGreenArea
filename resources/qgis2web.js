...
map.getView().fit([383583.311385, 6604591.915443, 436368.035208, 6667065.275043], map.getSize());
...
var points = [];
var url_osrm_nearest = 'https://router.project-osrm.org/nearest/v1/walking/';
var url_osrm_route = 'https://router.project-osrm.org/route/v1/walking/';
var icon_url = 'https://cdn.rawgit.com/openlayers/ol3/master/examples/data/icon.png';
var styles = {
	route: new ol.style.Style({
		stroke: new ol.style.Stroke({
		width: 6, color: [150, 40, 200, 0.8]
		})
	}),
...
// Routing to Green Area
var onSingleClick = function(evt) {
	points = [];
	layersList[3].getSource().clear()
	
	var pixel = map.getEventPixel(evt.originalEvent);
    var clickCoord = evt.coordinate;
	
	var source = layersList[2].getSource();

	
	var closestGArea = source.getClosestFeatureToCoordinate(clickCoord)
	var closestGCoord = closestGArea.getGeometry().getCoordinates()
